"""
Example parsing using a numpy module for less controlled testing scenario.  

Note that this file will __not__ run as expected and is in no way expected 
to perform any real task other than for harvesting documentation examples.
"""
import functools
import itertools
import operator
